...
interface CustomerIOPushNotificationCallback {
    ...
    /**
     * Called before setting flags for deep link intent. This is helpful in providing
     * custom flags for the intent that is about to be opened for the provided deep link.
     *
