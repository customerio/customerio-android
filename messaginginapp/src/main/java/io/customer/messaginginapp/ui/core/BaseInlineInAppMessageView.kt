...
constructor(
    ...
    override fun onAttachedToWindow() {
        ...
        // Subscribe directly on every attachment. This does not rely on Lifecycle replay, which is
        // important when Compose detaches and later reuses the same Android view instance.
        onViewOwnerCreated()
    }

    override fun onDetachedFromWindow() {
        super.onDetachedFromWindow()
        val lifecycle = observedLifecycle
