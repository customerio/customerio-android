 ...
 * decode must never let a polygon reach OS registration or business transitions: the enclosing circle
 * ([PolygonEnclosingCircle]) is a coarse proximity trigger, kilometres wider than the ring, so
