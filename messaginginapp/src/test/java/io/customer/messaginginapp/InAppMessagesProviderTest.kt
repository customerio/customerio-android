...
internal class InAppMessagesProviderTest : JUnitTest() {
    ...
    fun eventListener_givenEventListenerSet_expectCallEventListenerOnGistEvents() {
        ...
        verifyOnce { eventListenerMock.messageShown(expectedInAppMessage) }

        gistInAppMessagesProvider.onError(givenMessage)
        verifyOnce { eventListenerMock.errorWithMessage(expectedInAppMessage) }

        gistInAppMessagesProvider.onMessageDismissed(givenMessage)
        verifyOnce { eventListenerMock.messageDismissed(expectedInAppMessage) }
        ...
        verifyOnce { eventListenerMock.messageActionTaken(expectedInAppMessage, actionValue = givenAction, actionName = givenName) }
    }
    ...
    fun eventListener_givenEventListenerSet_expectCallEventListenerForEachEvent() {
        ...
        verifyOnce { eventListenerMock.messageShown(expectedInAppMessage1) }
        gistInAppMessagesProvider.onMessageShown(givenMessage2)
        verifyOnce { eventListenerMock.messageShown(expectedInAppMessage2) }
    }
}
