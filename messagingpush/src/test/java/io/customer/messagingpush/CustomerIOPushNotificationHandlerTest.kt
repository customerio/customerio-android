...
import io.customer.messagingpush.util.NotificationChannelManager
...
internal class CustomerIOPushNotificationHandlerTest : IntegrationTest() {
    ...
    override fun setup(testConfig: TestConfig) {
        ...
        pushNotificationHandler = CustomerIOPushNotificationHandler(mockk(relaxed = true), RemoteMessage(extras), NotificationChannelManager())
    ...
    fun handleMessage_givenNonCioBundle_shouldLogPushMessageEmpty() {
        ...
        val handler = CustomerIOPushNotificationHandler(mockk(relaxed = true), remoteMessage, NotificationChannelManager())
