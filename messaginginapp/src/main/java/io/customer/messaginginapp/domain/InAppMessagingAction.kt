...
sealed class InAppMessagingAction {
    ...
    data class DisplayModalMessage(val message: Message, val position: MessagePosition? = null) : InAppMessagingAction()
    ...
    data class QueueMessage(val message: Message) : InAppMessagingAction()
