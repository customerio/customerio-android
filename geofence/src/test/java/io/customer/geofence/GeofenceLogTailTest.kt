...
class GeofenceLogTailTest : RobolectricTest() {
    ...
    private fun invocations(): List<Row> {
        ...
        return listOf(
            ...
            Row("polygonArrivalEcho", "polygon.arrival.echo", listOf("id", "sh", "edge", "acc", "age"), GeofenceLogger::logPolygonArrivalEcho.name) { it.logPolygonArrivalEcho("notl_core", 10.0, 18.0, 0.3) },
