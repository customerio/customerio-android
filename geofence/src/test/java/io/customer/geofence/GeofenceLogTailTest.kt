...
class GeofenceLogTailTest : RobolectricTest() {
    ...
    private fun invocations(): List<Row> {
        ...
        return listOf(
            ...
            Row("polygonSamplingSkipped", "polygon.sampling.skipped", listOf("why"), GeofenceLogger::logPolygonSamplingSkipped.name, io = "in", pinned = mapOf("why" to "not_current_session")) { it.logPolygonSamplingSkipped(PolygonSamplingSkip.NOT_CURRENT_SESSION) },
            ...
            Row("polygonArrivalExpired", "polygon.arrival.expired", listOf("id", "sh", "held"), GeofenceLogger::logPolygonArrivalExpired.name) { it.logPolygonArrivalExpired("notl_core", 61.0) },
